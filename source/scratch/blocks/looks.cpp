...
BlockResult LooksBlocks::show(const Block& block, Sprite* sprite, const Block& waitingBlock, bool withoutScreenRefresh) {
    sprite->visible = true;
    return BlockResult::CONTINUE;
}
BlockResult LooksBlocks::hide(const Block& block, Sprite* sprite, const Block& waitingBlock, bool withoutScreenRefresh) {
...
BlockResult LooksBlocks::nextCostume(const Block& block, Sprite* sprite, const Block& waitingBlock, bool withoutScreenRefresh) {
    freeImage(sprite,sprite->costumes[sprite->currentCostume].id);
...
BlockResult LooksBlocks::nextBackdrop(const Block& block, Sprite* sprite, const Block& waitingBlock, bool withoutScreenRefresh) {
    for(Sprite* currentSprite : sprites){
        if(!currentSprite->isStage){
            continue;
        }
...
BlockResult LooksBlocks::goForwardBackwardLayers(const Block& block, Sprite* sprite, const Block& waitingBlock, bool withoutScreenRefresh){
...
BlockResult LooksBlocks::goToFrontBack(const Block& block, Sprite* sprite, const Block& waitingBlock, bool withoutScreenRefresh){
...
BlockResult LooksBlocks::setSizeTo(const Block& block, Sprite* sprite, const Block& waitingBlock, bool withoutScreenRefresh) {
...
BlockResult LooksBlocks::changeSizeBy(const Block& block, Sprite* sprite, const Block& waitingBlock, bool withoutScreenRefresh) {
