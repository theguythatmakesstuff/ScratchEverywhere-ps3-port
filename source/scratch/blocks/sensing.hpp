...
class SensingBlocks{
public:
    static BlockResult resetTimer(const Block& block, Sprite* sprite, Block* waitingBlock, bool withoutScreenRefresh);
    static BlockResult askAndWait(const Block& block, Sprite* sprite, Block* waitingBlock, bool withoutScreenRefresh);
